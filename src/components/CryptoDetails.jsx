...
const CryptoDetails = () => {
  ...
  const setValueForTimePeriod = (value) => {  

      if(value == 0) {
        let newValue = +value + 1;
        setTimePeriod(newValue.toString() + 'h');
      } else if (value == 1) {
        ...
        let newValue = +value + 21
        setTimePeriod(newValue.toString() + 'h');
      } else if (value == 4) {
        let newValue = +value + 3
        setTimePeriod(newValue.toString() + 'd');
      } else if (value == 5) {
        let newValue = +value + 25
        setTimePeriod(newValue.toString() + 'd');
      } else if (value == 6) {
        let newValue = +value - 3
        setTimePeriod(newValue.toString() + 'm');
      } else if (value == 6) {
        let newValue = +value - 3
        setTimePeriod(newValue.toString() + 'm');
      } else if (value == 7) {
        let newValue = +value - 6
        setTimePeriod(newValue.toString() + 'y');
      } else if (value == 8) {
  ...
  return (
    <Col className='coin-detail-container'>
      ...
      <Select 
        ...
        onChange={setValueForTimePeriod}
      >
